...
class Worker(object):
    ...
    def tgs_init(self):
        assert subprocess.call(['bash', './hijack/build.sh']) == 0
        ...
        self.tgs_mounts = {
            ...
            'vcuda': [
                root_path + ':/cluster',
                root_path + '/hijack/vcuda-lib/libcontroller.so:/libcontroller.so:ro',
                root_path + '/hijack/vcuda-lib/libcuda.so:/libcuda.so:ro',
                root_path + '/hijack/vcuda-lib/libcuda.so.1:/libcuda.so.1:ro',
                root_path + '/hijack/vcuda-lib/libnvidia-ml.so:/libnvidia-ml.so:ro',
                root_path + '/hijack/vcuda-lib/libnvidia-ml.so.1:/libnvidia-ml.so.1:ro',
                root_path + '/hijack/vcuda-lib/ld.so.preload:/etc/ld.so.preload:ro',
                root_path + '/gsharing:/etc/gsharing',
            ],
            'Ex': [
                root_path + ':/cluster',
